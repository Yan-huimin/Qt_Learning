...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/Data/Qt_logo.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/Data/Exit.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        Bt_Clear->setIcon(icon1);
